...
export function parseTransactions(lines) {
  ...
  for (const line of lines) {
    ...
    if (/opening balance|closing balance|payment received|surcharge waiver|transactions for|minimum amount due|finance charge|late payment fee|emi interest|emi instalment|emi principal|goods.{0,5}service.{0,5}tax|gst$|stpl emi|dial for cash/i.test(description)) continue;
